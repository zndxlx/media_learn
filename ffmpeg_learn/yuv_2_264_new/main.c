...
const char *inputFileName = "../../assert/1280x720_yuv420p.yuv"; //输入文件名
const char *outputFileName = "a.h264";                           //输出文件名
const int frameW = 1280;                                         //输入帧宽度
const int frameH = 720;                                          //输入帧高度
const int bitRate = 7500000;                                     //编码码率
const int frameToEncode = 300;                                   //共编码多少帧
